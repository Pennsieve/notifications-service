...
import akka.stream.alpakka.redis.{ RedisPubSub, RedisSubscriberSettings }
...
/**
  ...
  */
@InternalApi
private[redis] class RedisSubscribeSourceStage[K, V](
  topics: Seq[K],
  ...
  override def createLogic(inheritedAttributes: Attributes): GraphStageLogic =
    new GraphStageLogic(shape) {
      ...
      private val buffer: util.ArrayDeque[RedisPubSub[K, V]] =
        new java.util.ArrayDeque[RedisPubSub[K, V]]()

      private val successCallback: AsyncCallback[RedisPubSub[K, V]] =
        getAsyncCallback[RedisPubSub[K, V]](handleSuccess)
...
/**
  ...
  */
@InternalApi
private final class SubscribeListener[K, V](
  successListener: AsyncCallback[RedisPubSub[K, V]],
